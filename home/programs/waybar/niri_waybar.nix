...
let
  ...
  waybar_nord = pkgs.writeShellScriptBin "waybar_nord" ''
    killall .waybar-wrapped
    ${pkgs.waybar}/bin/waybar -c /home/${mi.userName}/.config/waybar/nord_config -s /home/${mi.userName}/.config/waybar/nord_style.css > /dev/null 2>&1 &
  '';
  waybar_light = pkgs.writeShellScriptBin "waybar_light" ''
    killall .waybar-wrapped
    ${pkgs.waybar}/bin/waybar -c /home/${mi.userName}/.config/waybar/light_config -s /home/${mi.userName}/.config/waybar/light_style.css > /dev/null 2>&1 &
  '';
in
{
  home.packages = [
