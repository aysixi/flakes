...
''
  ...
  # 从会话文件中读取下载任务
  input-file=/home/${user}/.config/aria2c/aria2.session


  # 会话文件保存路径
  # Aria2 退出时或指定的时间间隔会保存`错误/未完成`的下载任务到会话文件
  save-session=/home/${user}/.config/aria2c/aria2.session
  ...
  # IPv4 DHT 文件路径，默认：/home/${user}/.config/aria2c/dht.dat
  dht-file-path=/home/${user}/.config/aria2c/dht.dat

  # IPv6 DHT 文件路径，默认：/home/${user}/.config/aria2c/dht6.dat
  dht-file-path6=/home/${user}/.config/aria2c/dht6.dat
  ...
  on-download-stop=/home/${user}/.config/aria2c/delete.sh

  # 下载完成后执行的命令
  # 此项未定义则执行 下载停止后执行的命令 (on-download-stop)
  on-download-complete=/home/${user}/.config/aria2c/clean.sh
